...
if [ "$1" == "test" ]; then
  pamac install --no-confirm gtk3 webkit2gtk-4.1 gdk-pixbuf2 adwaita-icon-theme gnome-keyring gspell libvoikko hspell nuspell libunwind gstreamer curl libsecret libnotify libpng
fi
