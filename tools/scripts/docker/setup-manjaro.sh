...
if [ "$1" == "test" ]; then
  pacman -q -S --noconfirm gtk3 webkit2gtk-4.1 gdk-pixbuf2 librsvg adwaita-icon-theme gnome-keyring gspell libvoikko hspell nuspell libunwind gstreamer libsecret libnotify libpng
fi
