...
class TestPanel < Wx::Panel
  def initialize(parent, log)
    ...
    bf = Wx::Font.new(fs + 4, Wx::FONTFAMILY_SWISS, Wx::FONTSTYLE_NORMAL, Wx::FONTWEIGHT_BOLD)
    nf = Wx::Font.new(fs + 2, Wx::FONTFAMILY_SWISS, Wx::FONTSTYLE_NORMAL, Wx::FONTWEIGHT_NORMAL)
