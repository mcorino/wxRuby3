    ...
    class Event < Director
      ...
      def setup
        if spec.module_name == 'wxEvent'
          ...
          spec.ignore('wxEVT_HOTKEY') unless Config.instance.features_set?('USE_HOTKEY')
          spec.ignore('wxEVT_MOUSE_CAPTURE_CHANGED', 'wxEVT_MOUSE_CAPTURE_LOST', 'wxEVT_DISPLAY_CHANGED') unless Config.instance.features_set?('WXMSW')
