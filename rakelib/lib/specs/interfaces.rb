...
module WXRuby3
  ...
  Director.Package('Wx') { |pkg|
    ...
    Director.Spec(pkg, 'wxToolbook', director: Director::BookCtrls, requirements: %w[wxUSE_TOOLBOOK])
    Director.Spec(pkg, 'wxChoicebook', director: Director::BookCtrls, requirements: %w[wxUSE_CHOICEBOOK])
    Director.Spec(pkg, 'wxListbook', director: Director::BookCtrls, requirements: %w[wxUSE_LISTBOOK])
    Director.Spec(pkg, 'wxTreebook', director: Director::BookCtrls, requirements: %w[wxUSE_TREEBOOK])
  ...
  Director.Package('Wx::PRT', 'wxUSE_PRINTING_ARCHITECTURE') do |pkg|
    Director.Spec(pkg, 'wxPrinterDC', director: Director::DerivedDC, requirements: Director.AnyOf(*%w[__WXMSW__ __WXOSX__]))
